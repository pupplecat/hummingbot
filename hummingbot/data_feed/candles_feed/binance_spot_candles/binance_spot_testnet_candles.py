...
class BinanceSpotTestnetCandles(CandlesBase):
    ...
    @property
    def name(self):
        return f"binance_testnet_{self._trading_pair}"

    @property
    def rest_url(self):
        return CONSTANTS.REST_URL_TESTNET

    @property
    def wss_url(self):
        return CONSTANTS.WSS_URL_TESTNET
